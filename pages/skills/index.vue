    ...
    <section class="profile">
        ...
        <section class="pp-section">
            <header class="education__header pp-section__header">
                <h2 class="education__heading pp-section__heading">Compétences</h2>
            </header>
        </section>
        <section class="education pp-section">
            <header class="education__header pp-section__header">
                <h2 class="education__heading pp-section__heading">Formation</h2>
            </header>
